package com.revature.salad.utils.database;
...
public class ConnectionFactory {
    ...
    private ConnectionFactory(){
        try{
            props.load(new FileReader("ShoppingApp/src/main/resources/db.properties"));
        }catch(IOException e){
            e.printStackTrace();
        }
    }
    ...
    public Connection getConnection() throws SQLException{
        ...
        if (conn == null) throw new RuntimeException("Unable to connect to database");
        return conn;
    }
